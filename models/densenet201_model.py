...
class Model:
    ...
    def __init__(self, config):
        self.net = densenet201(num_classes=config['num_classes'], drop_prob=config['drop_prob'])
        self.config = config
        ...
        if config['logger']:
            ...
            self.logger = Logger(os.path.join(self.ckpt_path, 'densenet201.log')).get_logger()
