...
from nets.resnet_v2_sn import resnetv2sn50
...
class Model:
    ...
    def __init__(self, config):
        self.net = resnetv2sn50(num_classes=config['num_classes'], drop_prob=config['drop_prob'])
        self.config = config
        ...
        if config['logger']:
            ...
            self.logger = Logger(os.path.join(self.ckpt_path, 'resnet50v2_sn.log')).get_logger()
