...
"""
Created by Wang Han on 2018/10/23 14:07.
...
class Model:
    ...
    def __init__(self, config):
        self.net = dpn131(num_classes=config['num_classes'], pretrained=False)
        self.config = config
        ...
        if config['logger']:
            ...
            self.logger = Logger(os.path.join(self.ckpt_path, 'dpn131.log')).get_logger()
